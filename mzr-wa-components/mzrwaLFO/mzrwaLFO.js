...
class mzrwaLFO {
	...
	#setAmp() {
		mzrwaLFO.#setVariations( this.data, "absoluteAmp", "amp", this.#ampNode.gain, this.ctx.currentTime );
	}
	#setSpeed() {
		mzrwaLFO.#setVariations( this.data, "absoluteSpeed", "speed", this.#oscNode.frequency, this.ctx.currentTime );
	}
