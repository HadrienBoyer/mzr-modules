...
class MZRPatterns {
	...
	constructor() {
		const uiPatterns = MZRUI.$createElement( "mzrui-patterns" );
		const svgForms = Object.freeze( {
			keys: new mzruiKeysforms(),
			drums: new mzruiDrumsforms(),
			buffer: new mzruiWaveforms(),
			bufferHD: new mzruiWaveforms(),
			slices: new mzruiSlicesforms(),
		} );
