	...
	MZRUI.$createElement( "div", { class: "mzruiDAW-popup-cookies" },
		MZRUI.$createElement( "fieldset", null,
			...
			MZRUI.$createElement( "div", null,
				MZRUI.$createElement( "span", null, "Do you accept to let MozaRythm using Cookies to offers you 3 features :" ),
				MZRUI.$createElement( "ul", null,
					...
					MZRUI.$createElement( "li", null, "Connection to MozaRythm's server" ),
				),
